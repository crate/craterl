...
ct:
	@$(REBARC) skip_deps=true ct

test:
	$(CURDIR)/priv/ci/run_tests.sh
...
.PHONY: all all_but_dialyzer compile eunit test dialyzer clean allclean relclean distclean doc tags get-rebar rel devrel ct
